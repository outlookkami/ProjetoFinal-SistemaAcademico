...
type
  TTurmasPage = class(TForm)
    ...
    ToolBar2: TToolBar;
    dbedtProfTurmas: TDBEdit;
    dbedtDisciTurmas: TDBEdit;
    dbedtTurmaTurmas: TDBEdit;
 ...
 //Vai receber o código do Disciplina da uDisciplina
 //Vai receber o código do Professor da uProfessor
